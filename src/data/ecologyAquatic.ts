...
export const WILD_AQUATIC_SPECIES: Record<string, WildAquaticSpeciesDefinition> = {
  ...
  AQUATIC_LAGOON_SNAPPER: {
    ...
    dailyReproductionRate: 0.0016, naturalMortalityPerDay: 0.00024, mobility: 0.88, dailyFoodFraction: 0.022,
  ...
  AQUATIC_RIVER_CATFISH: {
    ...
    dailyReproductionRate: 0.0024, naturalMortalityPerDay: 0.00032, mobility: 0.72, dailyFoodFraction: 0.019,
  ...
  AQUATIC_MANGROVE_MULLET: {
    ...
    dailyReproductionRate: 0.0032, naturalMortalityPerDay: 0.00038, mobility: 0.86, dailyFoodFraction: 0.022,
  ...
  AQUATIC_BARRAMUNDI: {
    ...
    dailyReproductionRate: 0.00125, naturalMortalityPerDay: 0.0002, mobility: 0.92, dailyFoodFraction: 0.014,
