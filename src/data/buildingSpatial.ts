...
export const BUILDING_SPATIAL_PROFILES: Record<string, BuildingSpatialProfile> = {
  ...
  BUILDING_BAMBOO_SUPPLY_CRATE: {
    footprintAreaM2: 5,
    compatibleClusters: ['storage', 'shelter', 'research'],
    minBearing: 42,
    maxSlope: 12,
    maxFloodRisk: 38,
    preferredDrainage: 64,
    placementPriority: ['drainage', 'bearing', 'shelter', 'flatness'],
  },
  BUILDING_BULK_MATERIAL_RACK: {
    footprintAreaM2: 12,
    compatibleClusters: ['storage'],
    minBearing: 55,
    maxSlope: 12,
    maxFloodRisk: 48,
    preferredDrainage: 52,
  ...
  BUILDING_MEDICINE_STORAGE_CHEST: {
    ...
    maxSlope: 10,
    maxFloodRisk: 30,
    preferredDrainage: 72,
    placementPriority: ['shelter', 'drainage', 'flatness', 'bearing'],
  },
  BUILDING_BAMBOO_WATER_TANK: {
    footprintAreaM2: 10,
    compatibleClusters: ['storage', 'utility'],
    minBearing: 60,
    maxSlope: 8,
    maxFloodRisk: 45,
    preferredDrainage: 55,
    placementPriority: ['bearing', 'flatness', 'waterAccess', 'drainage'],
  },
  ...
  BUILDING_IRRIGATION_DITCH: {
    footprintAreaM2: 12,
    compatibleClusters: ['utility', 'farming'],
    minBearing: 18,
    maxSlope: 10,
    maxFloodRisk: 72,
    preferredDrainage: 45,
    placementPriority: ['waterAccess', 'flatness', 'drainage'],
  },
  BUILDING_DRAINAGE_DITCH: {
    footprintAreaM2: 12,
    compatibleClusters: ['utility', 'farming', 'livestock'],
    minBearing: 15,
    maxSlope: 12,
    maxFloodRisk: 90,
    preferredDrainage: 32,
    placementPriority: ['waterAccess', 'flatness', 'drainage'],
  },
  BUILDING_BAMBOO_WATER_CHANNEL: {
    ...
    maxFloodRisk: 68,
    preferredDrainage: 45,
    placementPriority: ['waterAccess', 'bearing', 'flatness'],
  },
