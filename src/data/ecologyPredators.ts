...
export const WILD_PREDATOR_SPECIES: Record<string, WildPredatorSpeciesDefinition> = {
  PREDATOR_MONITOR_LIZARD: {
    ...
    preyWeights: {
      FAUNA_GROUND_FROG: 1,
      FAUNA_FOREST_GECKO: 0.96,
      FAUNA_TREE_RAT: 0.92,
      FAUNA_MUD_CRAB: 0.86,
      FAUNA_FRUIT_DOVE: 0.82,
      FAUNA_FERAL_CHICKEN: 0.76,
      FAUNA_WILD_RABBIT: 0.62,
      FAUNA_FERAL_DUCK: 0.50,
      FAUNA_AGOUTI: 0.42,
      FAUNA_FLYING_FOX: 0.38,
      FAUNA_LARGE_FOREST_RODENT: 0.30,
    },
    supplementalDiet: { insects: 0.86, carrion: 0.14 },
    maxSupplementalDietShare: 0.24,
  ...
  PREDATOR_PYTHON: {
    ...
    preyWeights: {
      ...
      FAUNA_WILD_RABBIT: 0.92,
      FAUNA_AGOUTI: 0.88,
      FAUNA_FLYING_FOX: 0.76,
      FAUNA_FERAL_DUCK: 0.64,
      FAUNA_FRUIT_DOVE: 0.58,
      FAUNA_FERAL_CHICKEN: 0.54,
      FAUNA_TREE_RAT: 0.48,
      FAUNA_FOREST_GECKO: 0.24,
    ...
    maxAdultPreyKg: 16, juvenilePreference: 0.58,
  ...
  PREDATOR_RAPTOR: {
    ...
    preyWeights: {
      FAUNA_FRUIT_DOVE: 1,
      FAUNA_WILD_RABBIT: 0.94,
      FAUNA_FLYING_FOX: 0.88,
      FAUNA_TREE_RAT: 0.82,
      FAUNA_FERAL_CHICKEN: 0.78,
      FAUNA_FOREST_GECKO: 0.64,
      FAUNA_AGOUTI: 0.60,
      FAUNA_GROUND_FROG: 0.52,
      FAUNA_FERAL_DUCK: 0.48,
      FAUNA_LARGE_FOREST_RODENT: 0.26,
    },
  ...
  PREDATOR_CIVET: {
    ...
    preyWeights: {
      FAUNA_TREE_RAT: 0.94,
      FAUNA_FRUIT_DOVE: 0.86,
      FAUNA_FLYING_FOX: 0.78,
      FAUNA_FERAL_CHICKEN: 0.72,
      FAUNA_FOREST_GECKO: 0.68,
      FAUNA_GROUND_FROG: 0.62,
      FAUNA_MUD_CRAB: 0.52,
      FAUNA_WILD_RABBIT: 0.48,
      FAUNA_AGOUTI: 0.32,
    },
    supplementalDiet: { fruit: 0.58, insects: 0.42 },
    maxSupplementalDietShare: 0.38,
