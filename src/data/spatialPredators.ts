...
export const SPATIAL_PREDATOR_SPECIES: readonly SpatialPredatorSpeciesDefinition[] = Object.freeze([
  P({
    ...
    adultWeightKg: 8.5, dailyFoodKgPerAdult: .55, dailyWaterNeed: 38, densityPerKm2: 1.8, worldPresence: 1, minPatchSuitability: .36, minIslandCapacity: 5, initialOccupancy: [.48, .68],
  ...
  P({
    ...
    adultWeightKg: 24, dailyFoodKgPerAdult: .72, dailyWaterNeed: 32, densityPerKm2: 1.15, worldPresence: 1, minPatchSuitability: .4, minIslandCapacity: 4, initialOccupancy: [.44, .64],
  ...
  P({
    ...
    adultWeightKg: 4.8, dailyFoodKgPerAdult: .42, dailyWaterNeed: 20, densityPerKm2: .78, worldPresence: .96, minPatchSuitability: .4, minIslandCapacity: 3, initialOccupancy: [.42, .62],
  ...
  P({
    ...
    adultWeightKg: 5.4, dailyFoodKgPerAdult: .38, dailyWaterNeed: 30, densityPerKm2: 2.4, worldPresence: 1, minPatchSuitability: .34, minIslandCapacity: 6, initialOccupancy: [.52, .72],
  ...
  P({
    ...
    adultWeightKg: 180, dailyFoodKgPerAdult: 1.65, dailyWaterNeed: 90, densityPerKm2: .24, worldPresence: .92, minPatchSuitability: .58, minIslandCapacity: 2, initialOccupancy: [.38, .56],
