...
export type SpatialPredatorSocialMode = 'solitary_territory' | 'breeding_pair' | 'family_group' | 'loose_aggregation';
...
export interface SpatialPredatorSpeciesDefinition {
  ...
  homeRangeKm: number;
  socialMode: SpatialPredatorSocialMode;
  /** Breeding adults may meet across this graph distance even when they occupy different patches. */
  matingRangeKm: number;
  /** External metapopulation safety net. It creates dispersing founders, never a full replacement population. */
...
export const SPATIAL_PREDATOR_SPECIES: readonly SpatialPredatorSpeciesDefinition[] = Object.freeze([
  P({
    ...
    adultWeightKg: 8.5, dailyFoodKgPerAdult: .55, dailyWaterNeed: 38, maxKillsPerAdultPerDay: .42, densityPerKm2: 1.8, worldPresence: 1, minPatchSuitability: .36, minIslandCapacity: 5, initialOccupancy: [.48, .68],
    homeRangeKm: 1.4, socialMode: 'solitary_territory', matingRangeKm: 2.0, recolonizationDelayDays: [180, 540], recolonizationFounderCount: [1, 2],
    maxAdultPreyKg: 4.5, juvenilePreference: .58, huntSuccessBase: .34, maturityDays: 540, maxAgeDays: 5475, offspringPerAdultFemalePerYear: 1.8, disturbanceTolerance: 44,
  }),
  P({
    ...
    adultWeightKg: 24, dailyFoodKgPerAdult: .72, dailyWaterNeed: 32, maxKillsPerAdultPerDay: .16, densityPerKm2: 1.15, worldPresence: 1, minPatchSuitability: .4, minIslandCapacity: 4, initialOccupancy: [.44, .64],
    homeRangeKm: 1.8, socialMode: 'solitary_territory', matingRangeKm: 2.6, recolonizationDelayDays: [270, 720], recolonizationFounderCount: [1, 2],
    maxAdultPreyKg: 16, juvenilePreference: .62, huntSuccessBase: .28, maturityDays: 900, maxAgeDays: 7300, offspringPerAdultFemalePerYear: 1.1, disturbanceTolerance: 24,
  }),
  P({
    ...
    adultWeightKg: 4.8, dailyFoodKgPerAdult: .42, dailyWaterNeed: 20, maxKillsPerAdultPerDay: .34, densityPerKm2: .78, worldPresence: .96, minPatchSuitability: .4, minIslandCapacity: 3, initialOccupancy: [.42, .62],
    homeRangeKm: 3.2, socialMode: 'breeding_pair', matingRangeKm: 4.0, recolonizationDelayDays: [240, 720], recolonizationFounderCount: [1, 2],
    maxAdultPreyKg: 4.2, juvenilePreference: .52, huntSuccessBase: .31, maturityDays: 730, maxAgeDays: 6570, offspringPerAdultFemalePerYear: .85, disturbanceTolerance: 26,
  }),
  P({
    ...
    adultWeightKg: 5.4, dailyFoodKgPerAdult: .38, dailyWaterNeed: 30, maxKillsPerAdultPerDay: .3, densityPerKm2: 2.4, worldPresence: 1, minPatchSuitability: .34, minIslandCapacity: 6, initialOccupancy: [.52, .72],
    homeRangeKm: 1.25, socialMode: 'family_group', matingRangeKm: 1.8, recolonizationDelayDays: [120, 420], recolonizationFounderCount: [1, 2],
    maxAdultPreyKg: 3.5, juvenilePreference: .54, huntSuccessBase: .32, maturityDays: 420, maxAgeDays: 3650, offspringPerAdultFemalePerYear: 1.9, disturbanceTolerance: 58,
  }),
  P({
    ...
    adultWeightKg: 180, dailyFoodKgPerAdult: 1.65, dailyWaterNeed: 90, maxKillsPerAdultPerDay: .08, densityPerKm2: .24, worldPresence: .92, minPatchSuitability: .58, minIslandCapacity: 2, initialOccupancy: [.38, .56],
    homeRangeKm: 3.5, socialMode: 'loose_aggregation', matingRangeKm: 4.5, recolonizationDelayDays: [540, 1080], recolonizationFounderCount: [1, 2],
    maxAdultPreyKg: 90, juvenilePreference: .45, huntSuccessBase: .24, maturityDays: 3650, maxAgeDays: 21900, offspringPerAdultFemalePerYear: .38, disturbanceTolerance: 20,
  }),
]);
